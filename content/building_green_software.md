...
+ Hardware efficiency graph is the biggest takeaway from this book
+ Not a lot of detail (as evidenced by lack of diagrams, tables etc), but somewhat understandable since a lot of methods for improving software emissions are context dependent. Also as someone who has worked on large distributed systems for years and has an strong interest in climate change and energy systems I am maybe not the target audience.
+ 
