...
## Summary
Eased off on the $LaTeX$ for this one, writing out all the derivations just takes too much time.
## Homework
...
+ For discretised time
	+ Perfectly observed LDS ${red}{\frac{dx(t)}{dt} = A(t)x(t) + B(t)u(t) + w(t)}$
