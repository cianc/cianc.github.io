...
+ What does "reduction in [clinker](https://en.wikipedia.org/wiki/Cement_clinker) production" mean? I assume we're just importing it instead of changing how we make cement.
	+ [This article](https://oneclicklca.com/en/resources/articles/ireland-cement-mandate-for-state-building-projects) says that all state funded projects now require low-carbon cement and a "requirement for at least 30% clinker replacement with low-carbon alternatives in concrete".
+ What's driving the reduction in cattle and sheep herds?
	+ Can't find a single answer, but [this article](https://www.agriland.ie/farming-news/sheep-numbers-are-on-the-decline-across-europe/) makes it sound like sheep farming is low margin and precarious and any negative changes in price, labour availability, policy etc have an outsize impact.
+ Are we going to do anything about Agriculture?
	+ I really hope so.


> [!NOTE]- Sector by Sector Notes
...
> + Usage of peat declined by 8.6% vs 2023, consumption of all other fossil fuels increased. 2024 having 6.3% more [heating degree days](https://en.wikipedia.org/wiki/Heating_degree_day) than 2023.
>   
> #### Heavy industry
