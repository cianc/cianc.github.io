...
There have are now three publicised real-world implementations that I know of. Only three (and two of those with Google), but I think it's clear at this point that DC flexibility is technically feasible, and maybe the biggest hurdle left for wider deployment is to build confidence with utilities.

Of course the future of this AI boom driving this growth and creative demand management solutions is far from certain. Public sentiment seems to be shifting recently and reality may finally catching up with some of the hype. But if that happens and actual demand falls short of the astronomical predictions, having smarter DC load orchestration will still be a win that allows optimising workloads against cost/emissions/capacity.
### Emerald AI/Oracle/NVIDIA in Phoenix, Arizona
Emerald AI have a [paper](https://arxiv.org/pdf/2507.00909) on a field demonstration using their proprietary software in collaboration with Oracle and NVIDIA. This is part of [EPRIs DCFlex initiative](https://dcflex.epri.com/). 
