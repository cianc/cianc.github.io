...
**Update(2025-07-20)**: It also looks like US policy might be catching up: [https://bsky.app/profile/tnorris.bsky.social/post/3ludan3ckjc2v](https://bsky.app/profile/tnorris.bsky.social/post/3ludan3ckjc2v): ![[/image-56.png]]

### Questions
+ What about batteries to cover the relatively few hours of curtailment? A few recent white papers on datacenter microgrids and availability/renewables tradeoffs ([1](fast_scalable_clean_and_cheap_enough.md), [2](https://ember-energy.org/latest-insights/solar-electricity-every-hour-of-every-day-is-here-and-it-changes-everything/)) make this seem reasonable, and this seems to be part of the business model of [Verrus](https://www.verrusdata.com/). This recent [podcast](https://open.spotify.com/episode/4FaZ1O6Pvcax7vn5Dw4T6F, 4h battery capacity ) describes adding 280MWh for a 70MW datacenter to allow running without needing the grid to provision for peaks. That's 4h of battery capacity which seems like a reasonable fit for 1.7h average curtailment duration for 0.25% annual curtailment, but we'd have to see the distributions to be sure (paper only provides averages).
